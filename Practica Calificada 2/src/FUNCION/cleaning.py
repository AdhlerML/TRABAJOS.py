...
def clean_file(in_path: Path, out_path: Path, ts_col="timestamp", v_col_candidates=("voltage_V","voltaje","value")):
    ...
    with in_path.open("r", encoding="utf-8", newline="") as fin, \
        ...
        for row in reader:
            ...
            # Conversión de voltaje a humedad y temperatura
            ...
            writer.writerow({
                ...
                "voltage_V": f"{v:.3f}",
                "Temperatura_C": f"{tem_C:.3f}"
                
            })
            
          
            ts_list.append(t); volts_list.append(v); temp_list.append(tem_C); kept += 1
    ...
    return ts_list, volts_list,temp_list,stats